  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          MENU_PANEL,
          "stagger-menu max-h-(--radix-dropdown-menu-content-available-height) min-w-[10rem] overflow-x-hidden overflow-y-auto",
          className
        )}
        {...props}
      />
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(MENU_ITEM, "py-1.5 pr-2 pl-8", className)}
      checked={checked}
      {...props}
    >
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        MENU_ITEM,
        "data-[inset]:pl-8 data-[state=open]:bg-accent data-[state=open]:text-primary",
        className
      )}
      {...props}
    >
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(MENU_PANEL, "stagger-menu min-w-[10rem] overflow-hidden", className)}
      {...props}
    />
  )
}
