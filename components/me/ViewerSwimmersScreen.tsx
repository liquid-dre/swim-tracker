      ...
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/me/find"
              className="inline-flex h-11 lg:h-9 touch:h-11 items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 text-sm font-medium text-gray-700 outline-none transition-colors [transition-duration:var(--dur-1)] hover:bg-gray-50 focus-visible:ring-2 focus-visible:ring-ring"
            >
