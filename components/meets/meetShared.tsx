...
function SignupCell({
  ...
  return (
    <button
      ...
      className="inline-flex min-h-11 items-center gap-2 rounded-lg px-2 py-1 text-sm text-brand-600 transition-colors [transition-duration:var(--dur-1)] hover:bg-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 lg:min-h-0 touch:min-h-11"
    >
      {summary === "" ? (
