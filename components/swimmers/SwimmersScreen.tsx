      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="relative grow sm:max-w-xs">
          ...
          <input
            ...
            className="h-11 lg:h-9 touch:h-11 w-full rounded-lg border border-gray-300 bg-white pl-9 pr-3 text-base text-ink placeholder:text-ink-muted outline-none transition-[border-color] [transition-duration:var(--dur-1)] hover:border-gray-400 focus:border-brand-300 focus:shadow-focus-ring"
          />
        </div>
