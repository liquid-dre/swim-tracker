...
// Ferrofluid — generative WebGL "liquid metal" surface (React Bits, MIT).
// Used only on the public front door (landing / login / sign-up) to render a
// calm, water-like backdrop; the product app stays on the minimalist system.
// Wrapped by WaterBackground, which owns the palette, container and reduced-
// motion handling — prefer that over calling this directly.
