---
target: Season improvement chart page (R2)
total_score: 36
p0_count: 0
p1_count: 0
...
---
## Design Health Score — Season improvement (chart page, R2)

Anchor: **the season-improvement ranking bars**. Filters collapsed into one slim toolbar (primary inline: mode + event, inline) with secondary filters (season window (start date)) behind a compact Filters popover carrying an active-count badge. The tall filter card that used to push the chart down is gone.
...
1. **The chart is the hero.** Removing the tall filter card and collapsing controls into one slim toolbar puts the season-improvement ranking bars at the top of the page, centred and dominant above the fold.
