---
target: Comparison chart page (R2)
total_score: 37
p0_count: 0
p1_count: 0
timestamp: 2026-07-02T05-55-12Z
slug: components-compare-comparescreen-tsx
---
## Design Health Score — Comparison (chart page, R2)

Anchor: **the horizontal PB leaderboard bar chart**. Filters collapsed into one slim toolbar (primary inline: event distance / stroke / course selects, inline) with secondary filters (gender + exact age) behind a compact Filters popover carrying an active-count badge. The tall filter card that used to push the chart down is gone.
...
1. **The chart is the hero.** Removing the tall filter card and collapsing controls into one slim toolbar puts the horizontal PB leaderboard bar chart at the top of the page, centred and dominant above the fold.
