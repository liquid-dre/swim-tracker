---
target: Road to qualify chart page (R2)
total_score: 36
p0_count: 0
p1_count: 0
...
---
## Design Health Score — Road to qualify (chart page, R2)

Anchor: **the Gap-to-cut bar chart**. Filters collapsed into one slim toolbar (primary inline: swimmer + target-tier toggle, inline) with secondary filters (none (no secondary filters)) behind a compact Filters popover carrying an active-count badge. The tall filter card that used to push the chart down is gone.
...
1. **The chart is the hero.** Removing the tall filter card and collapsing controls into one slim toolbar puts the Gap-to-cut bar chart at the top of the page, centred and dominant above the fold.
