---
target: Coach dashboard greeting header (R4)
total_score: 36
p0_count: 0
p1_count: 0
timestamp: 2026-07-02T09-22-44Z
slug: components-dashboard-coachdashboardscreen-tsx
---
## Design Health Score — Coach dashboard greeting header (/dashboard, R4)

Assessed against a live-rendered screenshot of the PageHeader in three states (morning + name, evening + name, neutral no-name). the coach lands here after sign-in; the h1 is now a time-aware, personalised greeting at the DESIGN heading scale, with the breadcrumb still naming the location.
